...
def register(function_mapping):
    '''
    this function sets a relation between script names and
    analyzing functions, more than one script can be mapped by a single module

    see script names in timmy_data/rq/scripts folder
    '''
    function_mapping['script-filename'] = parsing_function
